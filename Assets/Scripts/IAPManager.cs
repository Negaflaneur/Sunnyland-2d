...
public class IAPManager : Singleton<IAPManager>, IStoreListener
{
    ...
    public string coin1000 = "coin1000";
    public string NO_ADS = "no_ads";
    public string Sup_Dev = "sup_dev";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(Sup_Dev, ProductType.NonConsumable);
    ...
    public void BuySup_Dev()
    {
        // Buy the non-consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(Sup_Dev);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, Sup_Dev, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // TODO: The non-consumable item has been successfully purchased, grant this item to the player.
            Debug.Log("Thanks for contributing to the futher development of this project");
        }
